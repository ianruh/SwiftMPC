...
extension LTVNumericObjective: Objective {
        ...
        flat.withUnsafeMutableBufferPointer { buffer in
            ...
            buffer[902] = -1.0 *
                (((-1.0 * self.previousAngle[1] + 1.0) * Double
                        ...
                        .sin(self.previousSteeringAngle[1] + self.previousAngle[1])) * 0.1 * self.previousVelocity[1])
            buffer[907] = 1.0
            buffer[1082] = -1.0 * 1.0
            buffer[1084] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[1] + 1.0) * Double.cos(self.previousSteeringAngle[1]) + Double
            ...
            buffer[1628] = -1.0 *
                (((-1.0 * self.previousAngle[2] + 1.0) * Double
                        ...
                        .sin(self.previousSteeringAngle[2] + self.previousAngle[2])) * 0.1 * self.previousVelocity[2])
            buffer[1633] = 1.0
            buffer[1808] = -1.0 * 1.0
            buffer[1810] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[2] + 1.0) * Double.cos(self.previousSteeringAngle[2]) + Double
            ...
            buffer[2354] = -1.0 *
                (((-1.0 * self.previousAngle[3] + 1.0) * Double
                        ...
                        .sin(self.previousSteeringAngle[3] + self.previousAngle[3])) * 0.1 * self.previousVelocity[3])
            buffer[2359] = 1.0
            buffer[2534] = -1.0 * 1.0
            buffer[2536] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[3] + 1.0) * Double.cos(self.previousSteeringAngle[3]) + Double
            ...
            buffer[3080] = -1.0 *
                (((-1.0 * self.previousAngle[4] + 1.0) * Double
                        ...
                        .sin(self.previousSteeringAngle[4] + self.previousAngle[4])) * 0.1 * self.previousVelocity[4])
            buffer[3085] = 1.0
            buffer[3260] = -1.0 * 1.0
            buffer[3262] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[4] + 1.0) * Double.cos(self.previousSteeringAngle[4]) + Double
            ...
            buffer[3806] = -1.0 *
                (((-1.0 * self.previousAngle[5] + 1.0) * Double
                        ...
                        .sin(self.previousSteeringAngle[5] + self.previousAngle[5])) * 0.1 * self.previousVelocity[5])
            buffer[3811] = 1.0
            buffer[3986] = -1.0 * 1.0
            buffer[3988] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[5] + 1.0) * Double.cos(self.previousSteeringAngle[5]) + Double
            ...
            buffer[4532] = -1.0 *
                (((-1.0 * self.previousAngle[6] + 1.0) * Double
                        ...
                        .sin(self.previousSteeringAngle[6] + self.previousAngle[6])) * 0.1 * self.previousVelocity[6])
            buffer[4537] = 1.0
            buffer[4712] = -1.0 * 1.0
            buffer[4714] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[6] + 1.0) * Double.cos(self.previousSteeringAngle[6]) + Double
            ...
            buffer[5258] = -1.0 *
                (((-1.0 * self.previousAngle[7] + 1.0) * Double
                        ...
                        .sin(self.previousSteeringAngle[7] + self.previousAngle[7])) * 0.1 * self.previousVelocity[7])
            buffer[5263] = 1.0
            buffer[5438] = -1.0 * 1.0
            buffer[5440] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[7] + 1.0) * Double.cos(self.previousSteeringAngle[7]) + Double
            ...
            buffer[5984] = -1.0 *
                (((-1.0 * self.previousAngle[8] + 1.0) * Double
                        ...
                        .sin(self.previousSteeringAngle[8] + self.previousAngle[8])) * 0.1 * self.previousVelocity[8])
            buffer[5989] = 1.0
            buffer[6164] = -1.0 * 1.0
            buffer[6166] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[8] + 1.0) * Double.cos(self.previousSteeringAngle[8]) + Double
            ...
            buffer[6710] = -1.0 *
                (((-1.0 * self.previousAngle[9] + 1.0) * Double
                        ...
                        .sin(self.previousSteeringAngle[9] + self.previousAngle[9])) * 0.1 * self.previousVelocity[9])
            buffer[6715] = 1.0
            buffer[6890] = -1.0 * 1.0
            buffer[6892] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[9] + 1.0) * Double.cos(self.previousSteeringAngle[9]) + Double
            ...
            buffer[7616] = -1.0 * 1.0
            buffer[7618] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[10] + 1.0) * Double.cos(self.previousSteeringAngle[10]) + Double
            ...
            buffer[8342] = -1.0 * 1.0
            buffer[8344] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[11] + 1.0) * Double.cos(self.previousSteeringAngle[11]) + Double
            ...
            buffer[9068] = -1.0 * 1.0
            buffer[9070] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[12] + 1.0) * Double.cos(self.previousSteeringAngle[12]) + Double
            ...
            buffer[9794] = -1.0 * 1.0
            buffer[9796] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[13] + 1.0) * Double.cos(self.previousSteeringAngle[13]) + Double
            ...
            buffer[10522] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[14] + 1.0) * Double.cos(self.previousSteeringAngle[14]) + Double
            ...
            buffer[11248] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[15] + 1.0) * Double.cos(self.previousSteeringAngle[15]) + Double
            ...
            buffer[11974] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[16] + 1.0) * Double.cos(self.previousSteeringAngle[16]) + Double
            ...
            buffer[12700] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[17] + 1.0) * Double.cos(self.previousSteeringAngle[17]) + Double
            ...
            buffer[13426] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[18] + 1.0) * Double.cos(self.previousSteeringAngle[18]) + Double
            ...
            buffer[14152] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[19] + 1.0) * Double.cos(self.previousSteeringAngle[19]) + Double
            ...
            buffer[14878] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[20] + 1.0) * Double.cos(self.previousSteeringAngle[20]) + Double
            ...
            buffer[15604] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[21] + 1.0) * Double.cos(self.previousSteeringAngle[21]) + Double
            ...
            buffer[16330] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[22] + 1.0) * Double.cos(self.previousSteeringAngle[22]) + Double
            ...
            buffer[17056] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[23] + 1.0) * Double.cos(self.previousSteeringAngle[23]) + Double
            ...
            buffer[17782] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[24] + 1.0) * Double.cos(self.previousSteeringAngle[24]) + Double
            ...
            buffer[18508] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[25] + 1.0) * Double.cos(self.previousSteeringAngle[25]) + Double
            ...
            buffer[19234] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[26] + 1.0) * Double.cos(self.previousSteeringAngle[26]) + Double
            ...
            buffer[19960] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[27] + 1.0) * Double.cos(self.previousSteeringAngle[27]) + Double
            ...
            buffer[20686] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[28] + 1.0) * Double.cos(self.previousSteeringAngle[28]) + Double
            ...
            buffer[21412] = -1.0 *
                (((-1.0 * self.previousSteeringAngle[29] + 1.0) * Double.cos(self.previousSteeringAngle[29]) + Double
    ...
    func inequalityConstraintsValue(_ x: Vector) -> Double {
        return Double.log((x[70] * -1.0 + -1.0471975511965976) * -1.0) * -1.0 + Double
            ...
            .log((x[82] + -1.0471975511965976) * -1.0) * -1.0 + Double.log((x[77] * -1.0 + -3.0) * -1.0) * -1.0 + Double
            .log((x[160] + -1.0471975511965976) * -1.0) * -1.0 + Double.log((x[53] + -1.0) * -1.0) * -1.0 + Double
            .log((x[28] * -1.0 + -1.0471975511965976) * -1.0) * -1.0 + Double
            .log((x[130] * -1.0 + -1.0471975511965976) * -1.0) * -1.0 + Double
            .log((x[17] + -1.0) * -1.0) * -1.0 + Double
            .log((x[23] + -1.0) * -1.0) * -1.0 + Double.log((x[10] * -1.0 + -1.0471975511965976) * -1.0) * -1.0 + Double
            ...
            .log((x[107] * -1.0 + -3.0) * -1.0) * -1.0 + Double.log((x[83] + -1.0) * -1.0) * -1.0 + Double
            .log((x[143] * -1.0 + -3.0) * -1.0) * -1.0 + Double.log((x[161] + -1.0) * -1.0) * -1.0 + Double
            .log((x[118] + -1.0471975511965976) * -1.0) * -1.0 + Double.log((x[41] + -1.0) * -1.0) * -1.0 + Double
            .log((x[76] * -1.0 + -1.0471975511965976) * -1.0) * -1.0 + Double
            .log((x[5] * -1.0 + -3.0) * -1.0) * -1.0 + Double
            .log((x[65] * -1.0 + -3.0) * -1.0) * -1.0 + Double.log((x[58] + -1.0471975511965976) * -1.0) * -1.0 + Double
            .log((x[167] + -1.0) * -1.0) * -1.0 + Double
            .log((x[178] * -1.0 + -1.0471975511965976) * -1.0) * -1.0 + Double
            .log((x[95] * -1.0 + -3.0) * -1.0) * -1.0 + Double.log((x[23] * -1.0 + -3.0) * -1.0) * -1.0 + Double
            ...
            .log((x[167] * -1.0 + -3.0) * -1.0) * -1.0 + Double.log((x[47] * -1.0 + -3.0) * -1.0) * -1.0 + Double
            ...
            .log((x[119] + -1.0) * -1.0) * -1.0 + Double.log((x[155] * -1.0 + -3.0) * -1.0) * -1.0 + Double
            .log((x[76] + -1.0471975511965976) * -1.0) * -1.0 + Double.log((x[53] * -1.0 + -3.0) * -1.0) * -1.0 + Double
            ...
            .log((x[119] * -1.0 + -3.0) * -1.0) * -1.0 + Double.log((x[89] * -1.0 + -3.0) * -1.0) * -1.0 + Double
            ...
            .log((x[107] + -1.0) * -1.0) * -1.0 + Double.log((x[137] * -1.0 + -3.0) * -1.0) * -1.0 + Double
            .log((x[28] + -1.0471975511965976) * -1.0) * -1.0 + Double.log((x[131] + -1.0) * -1.0) * -1.0 + Double
            .log((x[179] * -1.0 + -3.0) * -1.0) * -1.0 + Double
            .log((x[52] + -1.0471975511965976) * -1.0) * -1.0 + Double
            .log((x[35] + -1.0) * -1.0) * -1.0 + Double.log((x[41] * -1.0 + -3.0) * -1.0) * -1.0 + Double
            ...
            .log((x[4] * -1.0 + -1.0471975511965976) * -1.0) * -1.0 + Double.log((x[11] + -1.0) * -1.0) * -1.0 + Double
            ...
            .log((x[4] + -1.0471975511965976) * -1.0) * -1.0 + Double.log((x[113] + -1.0) * -1.0) * -1.0 + Double
            ...
            .log((x[143] + -1.0) * -1.0) * -1.0 + Double.log((x[88] + -1.0471975511965976) * -1.0) * -1.0 + Double
            .log((x[71] * -1.0 + -3.0) * -1.0) * -1.0 + Double.log((x[137] + -1.0) * -1.0) * -1.0 + Double
            ...
            .log((x[94] * -1.0 + -1.0471975511965976) * -1.0) * -1.0 + Double.log((x[5] + -1.0) * -1.0) * -1.0 + Double
            .log((x[17] * -1.0 + -3.0) * -1.0) * -1.0 + Double
            .log((x[40] * -1.0 + -1.0471975511965976) * -1.0) * -1.0 + Double
            .log((x[11] * -1.0 + -3.0) * -1.0) * -1.0 + Double.log((x[47] + -1.0) * -1.0) * -1.0 + Double
            .log((x[149] + -1.0) * -1.0) * -1.0 + Double.log((x[29] * -1.0 + -3.0) * -1.0) * -1.0 + Double
            ...
            .log((x[154] + -1.0471975511965976) * -1.0) * -1.0 + Double.log((x[29] + -1.0) * -1.0) * -1.0 + Double
            .log((x[77] + -1.0) * -1.0) * -1.0 + Double
            .log((x[166] * -1.0 + -1.0471975511965976) * -1.0) * -1.0 + Double
            .log((x[46] * -1.0 + -1.0471975511965976) * -1.0) * -1.0 + Double.log((x[71] + -1.0) * -1.0) * -1.0
    }
